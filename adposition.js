function adpositPhrase(arr, str){
    ...
    const next = str === "" ? current : 
			before ? `${current}, ${str}` : `${str}, ${current}`
...
const result = adpositPhrase(['this is the root','of the sentence','being typed','on a computer','for all to see','at this moment','with human language'], "")
console.log(result)
